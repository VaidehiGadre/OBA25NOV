...
public class UserController {
	...
	public ModelAndView accountstatement(HttpSession session, HttpServletRequest request) {
		if (session.getAttribute("user_id") != null) {
			return new ModelAndView("accountstatementoptions", new HashMap<>());
		} else {
			return new ModelAndView("login", new HashMap<>());
		}
	}
	
	@RequestMapping("/accountstatementsent")
	public ModelAndView accountstatementsent(HttpSession session, HttpServletRequest request) {
		if (session.getAttribute("user_id") != null) {
			return new ModelAndView("accountstatementformsent", new HashMap<>());
		} else {
			return new ModelAndView("login", new HashMap<>());
		}
	}
	
	@RequestMapping("/accountstatementreceived")
	public ModelAndView accountstatementreceived(HttpSession session, HttpServletRequest request) {
		if (session.getAttribute("user_id") != null) {
			return new ModelAndView("accountstatementformreceived", new HashMap<>());
		} else {
			return new ModelAndView("login", new HashMap<>());
		}
	}
	...
	@RequestMapping("/accountstatementsentprocess")
	public ModelAndView accountstatementsent(@RequestParam Date fromdate, @RequestParam Date todate, HttpSession session, HttpServletRequest request) {
		...
		map.put("SentStatements", listOfStatements);
		...
		return new ModelAndView("sentstatements", map);
	}

	@RequestMapping("/accountstatementreceivedprocess")
	public ModelAndView accountstatementreceived(@RequestParam Date fromdate, @RequestParam Date todate, HttpSession session, HttpServletRequest request) {
		/*
		 * String uname=(String)request.getSession().getAttribute("user_id");
		 * System.out.println(uname);
		 */
		...
		map.put("StatementsReceived", listOfStatementsReceived);
		return new ModelAndView("receivedstatements", map);
	}
